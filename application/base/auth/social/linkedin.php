...
class Linkedin implements MidrubBaseAuthInterfaces\Social {
    ...
    public function __construct() {
        ...
        // Get the Linkedin app id
        $this->app_id = get_option('linkedin_auth_app_id');
        
        // Get the Linkedin app secret
        $this->app_secret = get_option('linkedin_auth_app_secret');
        ...
        if (($this->app_id != '') AND ( $this->app_secret != '')) {
            ...
            $this->fb = new \Hybridauth\Provider\LinkedIn([
                'app_id' => $this->app_id,
